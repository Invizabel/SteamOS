# run this after archinstall, make sure you have git, steam, networkmanager, iwd, xorg-server, python, gdm, gnome, gnome-extra, and nvidia (if applicable) already installed, choose systemd, and pipewire for audio please. Run this script as root and name the user "steamos"
